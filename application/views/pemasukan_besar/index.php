...
$(document).ready(function(){
	...
	function tampil() {
		$.ajax({
			type:"POST",
			url:"<?php echo base_url();?>pemasukan_besar/tampil_pemasukan",
	...
	$("#simpan").click(function(){
		...
		/*else if (keterangan=="") {
			...
			$.ajax({
			type:"POST",
			url:"<?php echo base_url();?>pemasukan_besar/tambah_pemasukan",
	...
	$("#update").click(function(){
		...
		if (kode_akun=="") {
			...
			$.ajax({
			type:"POST",
			url:"<?php echo base_url();?>pemasukan_besar/edit_pemasukan",
	...
	$("#delete").live('click',function(){
		...
		var answer = confirm ("Apakah Anda Ingin Menghapus "+nama_pemasukan+" ?");
			if (answer==true) {
				...
				$.ajax({
						type:"POST",
						url:"<?php echo base_url();?>pemasukan_besar/delete_pemasukan",
...
<?php if(validation_errors()) { ?>
	...
	<div class="form-horizontal">
		  ...
		  <div class="control-group">
		  	<legend>Pemasukan Kas Besar</legend>
