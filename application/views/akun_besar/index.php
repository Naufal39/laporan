...
$(document).ready(function(){
	...
	function tampil() {
		$.ajax({
			type:"POST",
			url:"<?php echo base_url();?>akun_besar/tampil_akun",
	...
	$("#simpan").click(function(){
		...
		if (kode_akun=="") {
			...
			$.ajax({
			type:"POST",
			url:"<?php echo base_url();?>akun_besar/tambah_akun",
	...
	$("#update").click(function(){
		...
		$.ajax({
			type:"POST",
			url:"<?php echo base_url();?>akun_besar/update_akun",
	...
	$("#delete").live('click',function(){
		...
		var answer = confirm ("Apakah Anda Ingin Menghapus?");
			if (answer==true) {
				...
				$.ajax({
						type:"POST",
						url:"<?php echo base_url();?>akun_besar/delete_akun",
	...
	$("#nama_akun").live('click',function(){
		...
		$.ajax({
			...
			type:"POST",
			url : "<?php echo base_url();?>akun_besar/cek_kode_akun",
	...
	<div class="form-horizontal">
		  ...
		  <div class="control-group">
		  	<legend>Data Master Akun Besar</legend>
