...
$(document).ready(function(){
	...
	function tampil() {
		$.ajax({
			type:"POST",
			url:"<?php echo base_url();?>pengeluaran/tampil_pengeluaran",
	...
	$("#simpan").click(function(){
		...
		var saldo_total_besar = $("#saldo_total_besar").val();
		...
		if (kode_akun=="") {
			...
			$.ajax({
			type:"POST",
			url:"<?php echo base_url();?>pengeluaran/tambah_pengeluaran",
			data:"kode_akun="+kode_akun+"&nama_pengeluaran="+nama_pengeluaran+"&jumlah_pengeluaran="+jumlah_pengeluaran+"&tanggal_pengeluaran="+tanggal_pengeluaran+"&keterangan="+keterangan+"&saldo_total="+saldo_total+"&cek="+cek+"&saldo_total_besar="+saldo_total_besar ,
			success : function(data) {
	...
	$("#update").click(function(){
		...
		if (kode_akun=="") {
			...
			$.ajax({
			type:"POST",
			url:"<?php echo base_url();?>pengeluaran/edit_pengeluaran",
	...
	$("#delete").live('click',function(){
		...
		var answer = confirm ("Apakah Anda Ingin Menghapus Pengeluaran "+nama_pengeluaran+" ?");
			if (answer==true) {
				...
				$.ajax({
						type:"POST",
						url:"<?php echo base_url();?>pengeluaran/delete_pengeluaran",
	...
	$("#jumlah_pengeluaran").live('keyup',function(){
		...
		$.ajax({
			...
			type:"POST",
			url : "<?php echo base_url();?>pengeluaran/cek_pengeluaran",
...
<?php if(validation_errors()) { ?>
	...
	<div class="form-horizontal">
		  ...
		  <div class="control-group">
		   ...
		   <div class="control-group">
			<div class="controls">
			   <input type="checkbox" name="cek" value="cek" id="cek"> Pilih Checkbox jika ingin dimasukkan ke Pemasukan Kas Besar
			</div>
		  </div>
		  <div class="control-group">
			...
			<div class="controls">
				<?php 
				foreach ($data_saldo_besar->result_array() as $sal_besar) { ?>
		  		<input type="hidden" name="saldo_total_besar" id="saldo_total_besar" value="<?php echo $sal_besar['saldo_total'] ?>">
		  	<?php
		  	}
		  	?>
